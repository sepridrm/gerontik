...
const EvaluasiKeperawatan = ({ props, form_data }) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            <Actionsheet isOpen={isOpen} onClose={onClose}>
                <Actionsheet.Content>
                    <FormControl isRequired>
                        <Stack space={2} p={5}>
                            <View>
                                <FormControl.Label><Text>Evaluasi Keperawatan</Text></FormControl.Label>
                                <Input
                                    multiline
                                    value={form_data.evaluasi_keperawatan}
                                    onChangeText={(text) => form_data.setEvaluasiKeperawatan(text)}
                                    fontFamily="regular"
                                    multiline
                                    variant="underlined"
                    ...
                    <VStack>
                        <Box pl={10} py={3} bg="white">
                            <HStack space={1}>
                                ...
                                <Text style={{ width: '90%' }}>{item.evaluasi_keperawatan}</Text>
                            </HStack>
                        </Box>
                        <Divider />
            ...
            <Fab
                ...
                ml={getSize.widthScreen / 4.5}
                onPress={onOpen}
                position="absolute"
                label={<Text type="semi-bold" style={{ color: 'white' }}>Evaluasi Keperawatan</Text>}
...
export default EvaluasiKeperawatan
