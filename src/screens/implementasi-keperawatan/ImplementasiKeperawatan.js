...
const ImplementasiKeperawatan = ({ props, form_data }) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            <Actionsheet isOpen={isOpen} onClose={onClose}>
                <Actionsheet.Content>
                    <FormControl isRequired>
                        <Stack space={2} p={5}>
                            <View>
                                <FormControl.Label><Text>Implementasi Keperawatan</Text></FormControl.Label>
                                <Input
                                    multiline
                    ...
                    <VStack>
                        <Box pl={10} py={3} bg="white">
                            <HStack space={1}>
                                ...
                                <Text style={{ width: '90%' }}>{item.implementasi_keperawatan}</Text>
                            </HStack>
                        </Box>
                        <Divider />
            ...
            <Fab
                ...
                ml={getSize.widthScreen / 5.7}
                onPress={onOpen}
                position="absolute"
                label={<Text type="semi-bold" style={{ color: 'white' }}>Implementasi Keperawatan</Text>}
...
export default ImplementasiKeperawatan
